 ...
 *         $ref: '#/components/responses/InternalServerError'
 */
router.patch('/tasks/:taskId', authMiddleware, validateBody(updateTaskSchema), updateTask);
 ...
 *       대상 사용자가 소유한 공개(isPublic=true) 카테고리의 하위 태스크를 반환합니다.
 *       대상 사용자가 소유한 공개 카테고리의 태스크는 포함합니다.
 *       대상 사용자가 멤버로 참여 중인 다른 사용자의 공유 카테고리 태스크는 포함하지 않습니다.
